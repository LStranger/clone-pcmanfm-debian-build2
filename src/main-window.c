...
static void on_sort_by_size_activate (GtkMenuItem     *menuitem,
                                      gpointer         user_data);
static void on_sort_by_time_activate (GtkMenuItem     *menuitem,
                                      gpointer         user_data);
...
static void on_file_browser_open_item( PtkFileBrowser* file_browser,
                                      const char* upath, PtkOpenAction action,
                                      FMMainWindow* main_window );
...
static void on_file_browser_pane_mode_change( PtkFileBrowser* file_browser,
                                              FMMainWindow* main_window );
static void on_file_browser_property_change( PtkFileBrowser* file_browser,
                                             GParamSpec *param,
                                             FMMainWindow* main_window );
...
static PtkMenuItemEntry fm_sort_menu[] = {
  ...
  PTK_RADIO_MENU_ITEM( N_("Sort by _Time"), on_sort_by_time_activate, 0, 0 ),
  PTK_SEPARATOR_MENU_ITEM,
...
static PtkMenuItemEntry fm_view_menu[] = {
  ...
  PTK_SEPARATOR_MENU_ITEM,
  PTK_CHECK_MENU_ITEM( N_("Show _Hidden Files"), on_show_hidden_activate, 0, 0 ),
...
static PtkMenuItemEntry fm_tool_menu[] = {
  ...
  /*  TODO: Add su support
  PTK_IMG_MENU_ITEM( N_("Open Current Folder as _Root"), GTK_STOCK_DIALOG_AUTHENTICATION, NULL, 0, 0 ),
  */
  PTK_MENU_END
};
...
void fm_main_window_init( FMMainWindow* main_window )
{
  ...
  /* Start building GUI */
  gtk_window_set_icon( GTK_WINDOW(main_window), get_folder_icon32() );
  ...
  fm_view_menu[4].ret = (GtkMenuItem**)&main_window->show_hidden_files_menu;
  fm_view_menu[7].ret = (GtkMenuItem**)&main_window->view_as_icon;
  fm_view_menu[8].ret = (GtkMenuItem**)&main_window->view_as_list;
  fm_sort_menu[0].ret = (GtkMenuItem**)&main_window->sort_by_name;
  fm_sort_menu[1].ret = (GtkMenuItem**)&main_window->sort_by_size;
  fm_sort_menu[2].ret = (GtkMenuItem**)&main_window->sort_by_time;
  fm_sort_menu[4].ret = (GtkMenuItem**)&main_window->sort_ascending;
  fm_sort_menu[5].ret = (GtkMenuItem**)&main_window->sort_descending;
                                                   ...
                                                   PtkFileBrowser* file_browser )
{
  ...
  tab_icon = gtk_image_new_from_pixbuf (get_folder_icon20());
                                 ...
                                 PtkFileBrowserSidePaneMode side_pane_mode )
{
  ...
  switch( appSettings.sortOrder )
  {
    case FB_SORT_BY_NAME:
      ptk_file_browser_sort_by_name( file_browser );
      break;
    case FB_SORT_BY_SIZE:
      ptk_file_browser_sort_by_size( file_browser );
      break;
    case FB_SORT_BY_TIME:
      ptk_file_browser_sort_by_time( file_browser );
      break;
  };

  if( appSettings.sortType == GTK_SORT_ASCENDING )
    ptk_file_browser_sort_ascending( file_browser );
  else
    ptk_file_browser_sort_descending( file_browser );
  ...
  g_signal_connect( file_browser, "notify",
                    G_CALLBACK(on_file_browser_property_change), main_window );
                                              ...
                                              gpointer user_data )
{
  ...
  ptk_file_browser_chdir( file_browser, gtk_entry_get_text( entry ), TRUE );
  gtk_widget_grab_focus( GTK_WIDGET( file_browser->folder_view ) );
}
                                        ...
                                        gpointer         user_data)
{
  ...
  show_preference_dialog( main_window );
}
                                        ...
                                        gpointer         user_data)
{
  ...
  gtk_about_dialog_set_website (GTK_ABOUT_DIALOG (aboutDialog), "http://pcmanfm.csie.net/");
                                         ...
                                         gpointer         user_data)
{
  ...
  ptk_file_browser_update_mime_icons( file_browser );
  ...
  path = ptk_file_browser_get_cwd(file_browser);
  if( path ) {
    gtk_entry_set_text( main_window->address_bar, path );
    gtk_window_set_title( GTK_WINDOW(main_window), path );
  }
                                        ...
                                        gpointer         user_data)
{
  ...
  GtkWidget* file_browser;
  if ( gtk_widget_is_focus (main_window->address_bar) ) {
    gtk_editable_delete_selection( GTK_EDITABLE(main_window->address_bar) );
    return;
  }
  file_browser = fm_main_window_get_current_file_browser( main_window );
  ...
  if( G_LIKELY(upath) )
  {
    switch( action )
    {
      case PTK_OPEN_NEW_TAB:
        file_browser = fm_main_window_get_current_file_browser(main_window);
        fm_main_window_add_new_tab( main_window, upath,
                                    file_browser->show_side_pane,
                                    file_browser->side_pane_mode );
        break;
      case PTK_OPEN_NEW_WINDOW:
        file_browser = fm_main_window_get_current_file_browser(main_window);
        fm_main_window_add_new_window( main_window, upath,
                                       file_browser->show_side_pane,
                                       file_browser->side_pane_mode );
        break;
                                       ...
                                       PtkFileBrowser* file_browser )
{
  ...
  {
    case FB_SORT_BY_NAME:
      g_signal_handlers_block_matched(main_window->sort_by_name,
                                      G_SIGNAL_MATCH_FUNC, 0, 0, NULL,
                                      on_sort_by_name_activate, NULL);
      gtk_check_menu_item_set_active( main_window->sort_by_name, TRUE );
      g_signal_handlers_unblock_matched(main_window->sort_by_name,
                                        G_SIGNAL_MATCH_FUNC, 0, 0, NULL,
                                        on_sort_by_name_activate, NULL);
      break;
    case FB_SORT_BY_SIZE:
      g_signal_handlers_block_matched(main_window->sort_by_size,
                                      G_SIGNAL_MATCH_FUNC, 0, 0, NULL,
                                      on_sort_by_size_activate, NULL);
      gtk_check_menu_item_set_active( main_window->sort_by_size, TRUE );
      g_signal_handlers_unblock_matched(main_window->sort_by_size,
                                        G_SIGNAL_MATCH_FUNC, 0, 0, NULL,
                                        on_sort_by_size_activate, NULL);
      break;
    case FB_SORT_BY_TIME:
      g_signal_handlers_block_matched(main_window->sort_by_time,
                                      G_SIGNAL_MATCH_FUNC, 0, 0, NULL,
                                      on_sort_by_time_activate, NULL);
      gtk_check_menu_item_set_active( main_window->sort_by_time, TRUE );
      g_signal_handlers_unblock_matched(main_window->sort_by_time,
                                        G_SIGNAL_MATCH_FUNC, 0, 0, NULL,
                                        on_sort_by_time_activate, NULL);
      break;
  }
  ...
  if( file_browser->sort_type == GTK_SORT_ASCENDING ) {
    g_signal_handlers_block_matched(main_window->sort_ascending,
                                    G_SIGNAL_MATCH_FUNC, 0, 0, NULL,
                                    on_sort_ascending_activate, NULL);
    gtk_check_menu_item_set_active( main_window->sort_ascending, TRUE );
    g_signal_handlers_unblock_matched(main_window->sort_ascending,
                                      G_SIGNAL_MATCH_FUNC, 0, 0, NULL,
                                      on_sort_ascending_activate, NULL);
  }
  else{
    g_signal_handlers_block_matched(main_window->sort_descending,
                                    G_SIGNAL_MATCH_FUNC, 0, 0, NULL,
                                    on_sort_descending_activate, NULL);
    gtk_check_menu_item_set_active( main_window->sort_descending, TRUE );
    g_signal_handlers_unblock_matched(main_window->sort_descending,
                                      G_SIGNAL_MATCH_FUNC, 0, 0, NULL,
                                      on_sort_descending_activate, NULL);
  }
...
void on_file_browser_property_change( PtkFileBrowser* file_browser,
                                      GParamSpec *param,
                                      FMMainWindow* main_window )
{
  int pos;
  ...
  int current;
  GtkWidget* page;
  if( 0 == strncmp( "position", param->name, 8 ) )  {
    ...
    for( i = 0; i < n; ++i )  {
      ...
      g_signal_handlers_block_matched( page, G_SIGNAL_MATCH_FUNC, 0, 0, NULL,
                                       on_file_browser_property_change, NULL );
